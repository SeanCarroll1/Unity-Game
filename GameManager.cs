...
namespace Completed
{
	...
	public class GameManager : MonoBehaviour
	{
        ...
        [HideInInspector]
        public int health = 20;						//Starting value for Player food points.
        [HideInInspector]
        ...
        [HideInInspector]
        public static int level = 0;									//Current level number, expressed in game as "Level 1".
        ...
        void OnLevelWasLoaded(int index)
		{
            ...
            if (instance != null)
                ...
                //InitGame function to initialize the first level
                InitGame();
		...
		IEnumerator MoveEnemies()
		{
			...
			for (int i = 0; i < enemies.Count; i++)
			{
                ...
                //Ensure the object is still active, not (dead).
                if(enemies[i].gameObject.activeInHierarchy)
                {
                    //Call the MoveEnemy function of Enemy at index i in the enemies List.
                    enemies[i].MoveEnemy(enemies[i].tag);
                }
